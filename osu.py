...
class SuperHexagonInterface:
    ...
    def __init__(
            self,
            frame_skip=16,
            super_hexagon_path='E://Programmation//Python//qsu!//osu//osu.Desktop//bin//Debug//net5.0//osu!.exe',
            run_afap=True,
            record=False,
    ...
    def _esc(self, down):
        self.game.write_byte('osu!.exe', [0x00294B00, 0x42877], 1 if down else 0)
...
if __name__ == "__main__":
    truc = SuperHexagonInterface(allow_game_restart=True)
